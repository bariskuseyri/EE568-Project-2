...
oEditor.CreateComponent Array("NAME:ComponentProps", "Name:=", "ECE3_Model", _
  "Id:=", "168"), Array("NAME:Attributes", "Page:=", 1, "X:=", 0, "Y:=", 0, _
  "Degrees:=", 0, "Flip:=", false) 
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PassedParameterTab", _
  Array("NAME:PropServers", "CompInst@ECE3_Model;168;0"), Array(_
...
oEditor.CreateComponent Array("NAME:ComponentProps", "Name:=", "ECER_Model", _
  "Id:=", "175"), Array("NAME:Attributes", "Page:=", 1, "X:=", 0.0127, "Y:=", _
  0, "Degrees:=", 0, "Flip:=", false) 
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PassedParameterTab", _
  Array("NAME:PropServers", "CompInst@ECER_Model;175;0"), Array(_
  "NAME:ChangedProps", Array("NAME:RotAngMax", "OverridingDef:=", true, _
  "Value:=", "120"))))
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PassedParameterTab", _
  Array("NAME:PropServers", "CompInst@ECER_Model;175;0"), Array(_
  "NAME:ChangedProps", Array("NAME:InElecDeg", "OverridingDef:=", true, _
  "Value:=", "true"))))
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PassedParameterTab", _
  Array("NAME:PropServers", "CompInst@ECER_Model;175;0"), Array(_
...
oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:PassedParameterTab", _
  ...
  "Value:=", "2"))))
oEditor.CreateGround Array("NAME:GroundProps", "Id:=", "161"), Array(_
